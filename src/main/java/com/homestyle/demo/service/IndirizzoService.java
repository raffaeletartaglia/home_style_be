...
public class IndirizzoService {
     ...
     * @return
     */
    public List<Indirizzo> trovareIndirizziPerTipo(UUID idUtente, Indirizzo.Tipo tipo) {
     ...
     */
    @Transactional
    public Indirizzo aggiungiUnIndirizzo(UUID idUtente, Indirizzo indirizzo) {
     ...
     */
    @Transactional
    public Indirizzo modificaIndirizzo(UUID idIndirizzo, UUID idUtente, Indirizzo indirizzoModificato) {
     ...
     */
    @Transactional
    public void eliminaTuttiGliIndirizzi() {
